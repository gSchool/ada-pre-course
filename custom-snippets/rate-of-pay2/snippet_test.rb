...
describe "Test Suite" do
  ...
  it "will result in $1155.00 21 earnings and 10 hours" do
  ...
  it "will result in Please see manager for 11 per hour earnings and 61 hours" do
    output_list = user_input_helper(['11', '61'], FILENAME_TO_TEST)
  ...
  it "will result in $770.00 for 11 per hour earnings and 60 hours" do
    output_list = user_input_helper(['11', '60'], FILENAME_TO_TEST)
